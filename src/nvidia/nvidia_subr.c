...
nv_cap_t* NV_API_CALL nv_cap_init(
    const char *root
)
{
    return NULL;
...
nv_cap_t* NV_API_CALL nv_cap_create_dir_entry(
    nv_cap_t *parent_cap,
    const char *name,
    int mode
)
...
nv_cap_t* NV_API_CALL nv_cap_create_file_entry(
    nv_cap_t *parent_cap,
    const char *name,
    int mode
)
...
void NV_API_CALL nv_cap_destroy_entry(
    nv_cap_t *cap
)
{
}

int NV_API_CALL nv_cap_validate_and_dup_fd(
    const nv_cap_t *cap,
    int fd
)
{
...
void NV_API_CALL nv_cap_close_fd(
    int fd
)
{
}
